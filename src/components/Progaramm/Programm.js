...
import greenHeart from '../../assets/icons/green_heart.svg'
    ...
    return (
        <div className={styles.Root} id="programm">
            <div className={styles.Container}>
                ...
                <h2 className={styles.SubTitle}>23 августа 2024 г.</h2>
                <ul className={styles.List}>
                    <li className={styles.ListItem}>
                        <div className={styles.ListInfoTime}>16:00</div>
                        <div>
                            <div className={styles.ListItemInfo}>
                                <img src={greenHeart}/><span>Встреча гостей</span>
                            </div>
                            <div className={styles.ListItemSpace}></div>
                        </div>
                    </li>
                    <li className={styles.ListItem}>
                        <div className={styles.ListInfoTime}>16:30</div>
                        <div>
                            <div className={styles.ListItemInfo}>
                                <img src={greenHeart}/><span>Выездная церемония </span>
                            </div>
                            <div className={styles.ListItemSpace}></div>
                        </div>
                    </li>
                    <li className={styles.ListItem}>
                        <div className={styles.ListInfoTime}>17:00</div>
                        <div>
                            <div className={styles.ListItemInfo}>
                                <img src={greenHeart}/><span>Свадебный банкет</span>
                            </div>
                            <div className={styles.ListItemSpace}></div>
                        </div>
                    </li>
                    <li className={styles.ListItem}>
                        <div className={styles.ListInfoTime}>22:30</div>
                        <div>
                            <div className={styles.ListItemInfo}>
                                <img src={greenHeart}/><span>Завершение программы</span>
                            </div>
                            <div className={styles.ListItemSpace}></div>
                        </div>
                    </li>
                    <li className={styles.ListItem}>
                        <div className={styles.ListInfoTime}>23:00</div>
                        <div>
                            <div className={styles.ListItemInfo}>
                                <img src={greenHeart}/><span>Сборы и отъезд гостей</span>
                            </div>
                        </div>
                    </li>
                </ul>
